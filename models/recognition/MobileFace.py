...
def MobileFace(model_path=''):
    net = MobileFaceNet(embedding_size=512)
...
def extract_feature(feature_extractor, image_path):
    ...
    image_transform = transforms.Compose([transforms.Resize([112, 112]), transforms.ToTensor(),
...
if __name__ == '__main__':
    net = MobileFace(model_path='../../pretrained/MobileFace/model_mobilefacenet.pth')