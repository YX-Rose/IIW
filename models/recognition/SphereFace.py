...
def extract_feature(feature_extractor, image_path):
    ...
    image_transform = transforms.Compose([transforms.Resize([112, 96]), transforms.ToTensor(),
...
if __name__ == '__main__':
    net = SphereFace(model_path='../../pretrained/SphereFace/sphere20a_20171020.pth')
