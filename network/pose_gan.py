...
#B*32*128*128   B*64*128*128   B*64*64*64   B*64*64*64   B*128*32*32   B*128*32*32   B*256*32*32   B*256*16*16
...
class Decoder(nn.Module):
    def __init__(self, ngf, input_channel, output_channel, n_downsampling):
        ...
        self.fc = nn.Linear(256, 1024 * 4 * 4)
