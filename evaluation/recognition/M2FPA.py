...
def evaluate_recognition(probe_txt, gallery_txt, feature_extractor, data_root="../../datasets/M2FPA/collected_fr_data_pitch_align/", syn_root=''):
...
if __name__ == '__main__':
    ...
    evaluate_recognition("../../datasets/M2FPA/M2FPA_test_protocol/all_probe.txt",
                         "../../datasets/M2FPA/M2FPA_test_protocol/all_gallery.txt",
                         recognizer,
                         syn_root=syn_root)
